...
const OrderShop = () => {
  ...
  const [orderValueSearch, setOrderValueSearch] = useState("");
  const result = !orderValueSearch
    ? orders
    : orders.filter((item) =>
        item.product.name
          .toLowerCase()
          .includes(orderValueSearch.toLocaleLowerCase())
      );
        ...
        <>
          <div className="order__search">
            ...
            <input
              ...
              onChange={(e) => setOrderValueSearch(e.target.value)}
              value={orderValueSearch}
            />
          </div>
                  ...
                  <div className="list__order">
                    <div className="list__order-item">
                      <div className="order__navbar-heading">
                        <span className="navbar__heading-time">
                          Ngày đặt hàng: {convertDateTime(item.createdAt)}
                        </span>
                  ...
                  <div className="list__order">
                    <div className="list__order-item">
                      <div className="order__navbar-heading">
                        <span className="navbar__heading-time">
                          Ngày đặt hàng:{" "}
                          {convertDateTime(item.transaction.createdAt)}
                        </span>
                        <span className="navbar__heading-name">
                          Người mua: {item.transaction.user?.name}
                        </span>
